          ...
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-semibold">TechForge</span>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-primary-foreground/80">hello@techforge.com</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-primary-foreground/80">Silicon Valley, CA</span>
                </div>
              </div>
