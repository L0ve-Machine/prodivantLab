...
const contactInfo = [
  {
    icon: Mail,
    title: 'Email Us',
    details: 'prodivant.jp@gmail.com',
    description: 'Send us an email anytime!'
  },
  {
    icon: MapPin,
    title: 'Visit Us',
    details: '12-12, Osaka-Ekimae Daini Building, 1-2-2 Umeda, Kita-ku, Osaka-shi, Osaka 530-0001, Japan',
    description: 'Come say hello at our office'
  },
  {
    icon: Clock,
    title: 'Working Hours',
    details: 'Mon - Fri: 8am - 10pm JST',
...
export function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    submissions.unshift(submission); // Add new submission at the beginning
